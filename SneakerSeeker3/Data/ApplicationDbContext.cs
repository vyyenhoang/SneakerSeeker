...
namespace SneakerSeeker3.Data
{
	public class ApplicationDbContext : IdentityDbContext<SneakerSeekerUser, StoreRole, String>
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			new Models.Product() { ProductId = 17, SKU = "0017A", ProductName = "Nike Jordan 13 Retro Alternate - Men", ProductDescription = "The Jordan Retro 13 is a retro version of the shoe MJ wore as he captured his sixth championship", CategoryId = 5, SupplierId = 1, ItemColorId = 4, UnitPrice = 150, ProductURL = "https://www.flightclub.com/media/catalog/product/cache/1/image/1600x1140/9df78eab33525d08d6e5fb8d27136e95/8/0/801265_1.jpg" },
