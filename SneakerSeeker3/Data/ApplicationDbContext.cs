...
namespace SneakerSeeker3.Data
{
	public class ApplicationDbContext : IdentityDbContext<SneakerSeekerUser, StoreRole, String>
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			new Models.Product() { ProductId = 6, SKU = "0006A", ProductName = "Adidas Yeezy Boost 350 Shoes - Men", ProductDescription = "Last collection of Adidas 2019", CategoryId = 5, SupplierId = 2, ItemColorId = 2, UnitPrice = 200, ProductURL = "https://www.flightclub.com/media/catalog/product/cache/1/image/1600x1140/9df78eab33525d08d6e5fb8d27136e95/8/0/802389_01.jpg" },
