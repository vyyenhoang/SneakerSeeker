...
namespace SneakerSeeker3.Data
{
	public class ApplicationDbContext : IdentityDbContext<SneakerSeekerUser, StoreRole, String>
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			new Models.Product() { ProductId = 2, SKU = "0002A", ProductName = "Nike Black Nike Air Force 1 Low - Men", ProductDescription = "The classic Black Air Force 1 mixed with silver color", CategoryId = 6, SupplierId = 1, ItemColorId = 5, UnitPrice = 200, ProductURL = "https://c.static-nike.com/a/images/t_PDP_1280_v1/f_auto/oplkqwyf7nwnj98f8agj/air-force-1-07-triple-black-mens-shoe-JkTGzADv.jpg" },
			new Models.Product() { ProductId = 3, SKU = "0003A", ProductName = "Nike Air Jordan - Men", ProductDescription = "The most modren on in Air Jordan Collection ", CategoryId = 5, SupplierId = 1, ItemColorId = 4, UnitPrice = 150, ProductURL = "https://c.static-nike.com/a/images/t_PDP_1280_v1/f_auto/z7i1be9xlxbbqwubh5yi/air-jordan-1-mid-shoe-VzFBKF.jpg" },
			...
			new Models.Product() { ProductId = 5, SKU = "0005A", ProductName = "Nike Gray Sneaker 2018 - Women", ProductDescription = "The regular edtiton of women 2018", CategoryId = 2, SupplierId = 1, ItemColorId = 3, UnitPrice = 150, ProductURL = "https://cdn.shopify.com/s/files/1/1512/2122/products/017_Mens_Mihara_Multi_Color_Canvas_Original_Sole_Sneaker-2_copy_1024x.jpg?v=1571772687" },
			new Models.Product() { ProductId = 6, SKU = "0006A", ProductName = "Adidas Yeezy Boost 350 Shoes - Men", ProductDescription = "Last collection of Adidas 2019", CategoryId = 5, SupplierId = 2, ItemColorId = 2, UnitPrice = 200, ProductURL = "https://cdn.yoox.biz/45/45437288ff_13_n_f.jpg" },
			...
			new Models.Product() { ProductId = 11, SKU = "0011A", ProductName = "Fila Disruptor II Premium - Women", ProductDescription = "FILA’s most popular women’s silhouette", CategoryId = 2, SupplierId = 4, ItemColorId = 4, UnitPrice = 200, ProductURL = "https://scene7.zumiez.com/is/image/zumiez/pdp_hero/FILA-Disruptor-Multicolor-%26-White-Shoes-_311646-front-US.jpg" },
			...
			new Models.Product() { ProductId = 13, SKU = "0013A", ProductName = "Vans Era - Men", ProductDescription = "The Era, Vans classic low top lace-up skate shoe", CategoryId = 1, SupplierId = 5, ItemColorId = 7, UnitPrice = 150, ProductURL = "https://imagescdn.simons.ca/images/8728-319317-60-A1_2/era-bright-red-sneakers-men.jpg?__=3" },
			new Models.Product() { ProductId = 14, SKU = "0014A", ProductName = "Vans Authentic - Women", ProductDescription = "The Authentic, Vans original and now iconic style, is a simple low top", CategoryId = 1, SupplierId = 5, ItemColorId = 1, UnitPrice = 200, ProductURL = "https://scene7.zumiez.com/is/image/zumiez/pdp_hero/FILA-Disruptor-II-3D-Embroidery-White-Shoes-_323532-front-US.jpg" },
			new Models.Product() { ProductId = 15, SKU = "0015A", ProductName = "Adidas Yeezy Boost 350 V2 - women", ProductDescription = "This is one of three regional exclusive colorways that released in March 2019", CategoryId = 2, SupplierId = 2, ItemColorId = 8, UnitPrice = 150, ProductURL = "https://www.biorley.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/j/j/jj657.jpg" },
			new Models.Product() { ProductId = 16, SKU = "0016A", ProductName = "Adidas EQT Basketball ADV Unisex Running Soes - Men", ProductDescription = "The first sneaker in the EQT line designed with the baller in mind", CategoryId = 5, SupplierId = 2, ItemColorId = 2, UnitPrice = 200, ProductURL = "https://media.endclothing.com/media/catalog/product/2/3/23-03-2018_adidas_eqtbaskadvw_ashblue_white_ac7353_mg_1.jpg" },
			new Models.Product() { ProductId = 17, SKU = "0017A", ProductName = "Nike Jordan 13 Retro Alternate - Men", ProductDescription = "The Jordan Retro 13 is a retro version of the shoe MJ wore as he captured his sixth championship", CategoryId = 5, SupplierId = 1, ItemColorId = 4, UnitPrice = 150, ProductURL = "https://stockx-360.imgix.net/Air-Jordan-13-Retro-Alternate-History-Of-Flight/Images/Air-Jordan-13-Retro-Alternate-History-Of-Flight/Lv2/img01.jpg?auto=format,compress&w=559&q=90&dpr=2&updated_at=1546679301" },
			new Models.Product() { ProductId = 18, SKU = "0018A", ProductName = "Nike Air Max 1 - women", ProductDescription = "Keep your outfit cookin with a pair of these Nike Air Max 1", CategoryId = 2, SupplierId = 1, ItemColorId = 7, UnitPrice = 200, ProductURL = "https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/ikvlpfgtitt6mybtdcug/nike-air-max-1-premium-dark-curry-release-date.jpg" },
